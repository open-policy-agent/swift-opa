...
extension Decimal {
    private static let int64MinDecimal = Decimal(Int64.min)
    private static let int64MaxDecimal = Decimal(Int64.max)
    ...
    public var int64Value: Int64 {
        guard self >= Self.int64MinDecimal && self <= Self.int64MaxDecimal else {
    ...
    public var uint64Value: UInt64 {
        ...
        guard self <= Self.uint64MaxDecimal else { return UInt64.max }
    ...
    public var safeInt64Value: Int64? {
        ...
        guard self >= Self.int64MinDecimal && self <= Self.int64MaxDecimal else { return nil }
