...
extension BuiltinTests.ArithmeticTests {
    ...
    static let mulTests: [BuiltinTests.TestCase] = [
        ...
        BuiltinTests.TestCase(
            ...
            expected: .success(.number(RegoNumber.decimal(Decimal(999_999_999_999_999_999) * Decimal(10000))))
        ),
        BuiltinTests.TestCase(
            description: "not enough args",
            name: "mul",
    ...
    static let divTests: [BuiltinTests.TestCase] = [
        ...
        BuiltinTests.TestCase(
            ...
            expected: .success(.number(RegoNumber.decimal(Decimal(1) / Decimal(3))))
        ),
        BuiltinTests.TestCase(
