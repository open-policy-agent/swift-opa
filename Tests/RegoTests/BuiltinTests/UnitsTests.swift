...
extension BuiltinTests.UnitsTests {
    ...
    static let unitsParseTests: [BuiltinTests.TestCase] = [
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["500m"],
            expected: .success(.number(0.5 as NSNumber))
        ),
        BuiltinTests.TestCase(
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["\"100TI\""],
            expected: .success(.number(109_951_162_777_600 as NSNumber))
        ),
        BuiltinTests.TestCase(
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["0"],
            expected: .success(.number(0 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "0.0 == 0",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["12345"],
            expected: .success(.number(12345 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "10K == 10000",
            name: "units.parse",
            args: ["10K"],
            expected: .success(.number(10000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "10KI == 10240",
            name: "units.parse",
            args: ["10KI"],
            expected: .success(.number(10240 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "10k == 10000",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["200M"],
            expected: .success(.number(200_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "300Gi == 322122547200",
            name: "units.parse",
            args: ["300Gi"],
            expected: .success(.number(322_122_547_200 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "1.1K == 1100",
            name: "units.parse",
            args: ["1.1K"],
            expected: .success(.number(1100 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "1.1Ki == 1126.4",
            name: "units.parse",
            args: ["1.1Ki"],
            expected: .success(.number(1126.4 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: ".5K == 500",
            name: "units.parse",
            args: [".5K"],
            expected: .success(.number(500 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100k == 100000",
            name: "units.parse",
            args: ["100k"],
            expected: .success(.number(100000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100K == 100000",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["100ki"],
            expected: .success(.number(102400 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100Ki == 102400",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["100M"],
            expected: .success(.number(100_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100mi == 104857600",
            name: "units.parse",
            args: ["100mi"],
            expected: .success(.number(104_857_600 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100Mi == 104857600",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["100g"],
            expected: .success(.number(100_000_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100gi == 107374182400",
            name: "units.parse",
            args: ["100gi"],
            expected: .success(.number(107_374_182_400 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100t == 100000000000000",
            name: "units.parse",
            args: ["100t"],
            expected: .success(.number(100_000_000_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100T == 100000000000000",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["100p"],
            expected: .success(.number(100_000_000_000_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100P == 100000000000000000",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["100pi"],
            expected: .success(.number(112_589_990_684_262_400 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "100Pi == 112589990684262400",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["10e"],
            expected: .success(.number(exo as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "10E == 10000000000000000000",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["10ei"],
            expected: .success(.number(ei as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "10Ei == 11529215046068469760",
            name: "units.parse",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse",
            args: ["1e10"],
            expected: .success(.number(10_000_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "3.2E4 == 32000",
            name: "units.parse",
            args: ["3.2E4"],
            expected: .success(.number(32000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "2.5e3K == 2500000",
            name: "units.parse",
            args: ["2.5e3K"],
            expected: .success(.number(2_500_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "1e3M == 1000000000",
            name: "units.parse",
            args: ["1e3M"],
            expected: .success(.number(1_000_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "4E2G == 400000000000",
            name: "units.parse",
            args: ["4E2G"],
            expected: .success(.number(400_000_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "5e1Gi == 53687091200",
            name: "units.parse",
            args: ["5e1Gi"],
            expected: .success(.number(53_687_091_200 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "1e-2 == 0.01",
            name: "units.parse",
            args: ["1e-2"],
            expected: .success(.number(0.01 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "7.8E-1 == 0.78",
            name: "units.parse",
            args: ["7.8E-1"],
            expected: .success(.number(0.78 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "6e3Mi == 6291456000",
            name: "units.parse",
            args: ["6e3Mi"],
            expected: .success(.number(6_291_456_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "42 == 42",
            name: "units.parse",
            args: ["42"],
            expected: .success(.number(42 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "-3.5E2m == -0.35",
            name: "units.parse",
            args: ["-3.5E2m"],
            expected: .success(.number(-0.35 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "128Gi == 137438953472",
            name: "units.parse",
            args: ["128Gi"],
            expected: .success(.number(137_438_953_472 as NSNumber))
        ),
    ]
    ...
    static let unitBytesParseTests: [BuiltinTests.TestCase] = [
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse_bytes",
            args: ["1.1KiB"],
            expected: .success(.number(1126 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: ".5KB == 500",
            name: "units.parse_bytes",
        ...
        BuiltinTests.TestCase(
            ...
            name: "units.parse_bytes",
            args: ["1e3KB"],
            expected: .success(.number(1_000_000 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "3.2E2MiB == 335544320",
            name: "units.parse_bytes",
            args: ["3.2E2MiB"],
            expected: .success(.number(335_544_320 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "4.5e1GiB == 48318382080",
            name: "units.parse_bytes",
            args: ["4.5e1GiB"],
            expected: .success(.number(48_318_382_080 as NSNumber))
        ),
        BuiltinTests.TestCase(
            description: "5e6 == 5000000",
            name: "units.parse_bytes",
            args: ["5e6"],
            expected: .success(.number(5_000_000 as NSNumber))
        ),
    ]
...
@Suite("NSNumber.toNumberRegoValue Extension")
struct NSNumberToNumberRegoValueExtensionTests {
    @Test
    func returnsUIntForBoolean() {
        let expectedTruthy: UInt64 = 1
        #expect(NSNumber(value: true).toNumberRegoValue() == .number(expectedTruthy as NSNumber))

        let expectedFalsy: UInt64 = 0
        #expect(NSNumber(value: false).toNumberRegoValue() == .number(expectedFalsy as NSNumber))
    }

    @Test
    func returnsUIntForPositiveWholeNumbers() {
        let expectedWhole: UInt64 = 1024 * 1024 * 1024 * 1024 * 1024 * 1024
        let inputWholeDouble: Double = 0.0 + Double(expectedWhole)
        let inputFractionalDouble: Double = 0.78987 + Double(expectedWhole)

        #expect(NSNumber(value: inputWholeDouble).toNumberRegoValue() == .number(expectedWhole as NSNumber))
        #expect(
            NSNumber(value: inputFractionalDouble).toNumberRegoValue(asInt: true) == .number(expectedWhole as NSNumber))
    }
    ...
    func returnsIntForNegativeWholeNumbers() {
        ...
        #expect(NSNumber(value: inputWholeDouble).toNumberRegoValue() == .number(expectedWhole as NSNumber))
        #expect(
            NSNumber(value: inputFractionalDouble).toNumberRegoValue(asInt: true)
                == .number(expectedWhole + 1 as NSNumber))
    }

    @Test
    func returnsSelfForFractionalNumbers() {
        let inputFractionalDouble: Double = Double.pi

        #expect(
            NSNumber(value: inputFractionalDouble).toNumberRegoValue() == .number(inputFractionalDouble as NSNumber))
    }
}
